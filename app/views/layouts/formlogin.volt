...
{#{% if this.session.has('email') or this.cookies.has('email') %}#}
...
{{ form("","method":"post","class":"form-horizontal") }}
  <div class="form-group">
    ...
    <div class="col-md-9">
      {{ text_field("email","class":"form-control","placeholder":"example@sample.com") }}
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      {{ check_field("remember") }}
    </div>
  </div>

  <div class="form-group text-center">
    {{ submit_button("Submit","class":"btn btn-primary btn-lg") }}
  ...
  <a href="{{ url.getBaseUri() }}authen/googlecallback" style="color: green;">Login to Google Plus</a>
  {#<a href="#" id="logoutFacebook">Logout to Facebook</a>#}
{{ end_form() }}
